...
<table class="table align-middle mb-0">
  ...
  <?php foreach ($requests as $r):
    ...
    $isConsolidated = !empty($r['is_consolidated']);
    $displayDepartment = $isConsolidated ? 'IETW (Consolidated)' : e($r['department_name']);
  ?>
  <tr>
    <td><?= e($r['request_no']) ?></td>
    <td><?= $displayDepartment ?> <?= $isConsolidated ? '<span class="badge bg-secondary ms-1">Merged</span>' : '' ?></td>
    <td><?= e($r['purpose']) ?></td>
